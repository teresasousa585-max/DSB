...
for sx,sy in cases:
    ...
    print("case", sx, sy, "sl", sl, "p99", p99)
ap=design_n12_unit.aperture_mm(pts)
unit_width=max(ap["width_centers_mm"],ap["height_centers_mm"])+design_n12_unit.ELEMENT_DIAMETER_MM+4.0
score=max_sl+0.35*p99_sl
spacing=design_n12_unit.min_spacing_mm(pts)
print("score", score, "unit_width", unit_width, "spacing", spacing)
