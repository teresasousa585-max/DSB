// ==========================================================================
// 自动生成的 LUT — 由 analysis/lut_generator.py 生成
// ==========================================================================
    ...
    // hann 窗 LUT
    assign window_hann[ 0] = 8'd0;
    assign window_hann[ 1] = 8'd0;
    assign window_hann[ 2] = 8'd0;
    assign window_hann[ 3] = 8'd0;
    assign window_hann[ 4] = 8'd0;
    assign window_hann[ 5] = 8'd0;
    assign window_hann[ 6] = 8'd64;
    assign window_hann[ 7] = 8'd128;
    assign window_hann[ 8] = 8'd64;
    assign window_hann[ 9] = 8'd0;
    assign window_hann[10] = 8'd0;
    assign window_hann[11] = 8'd128;
    assign window_hann[12] = 8'd255;
    assign window_hann[13] = 8'd128;
    assign window_hann[14] = 8'd0;
    assign window_hann[15] = 8'd0;
    assign window_hann[16] = 8'd64;
    assign window_hann[17] = 8'd128;
    assign window_hann[18] = 8'd64;
    assign window_hann[19] = 8'd0;
    assign window_hann[20] = 8'd0;
    assign window_hann[21] = 8'd0;
    assign window_hann[22] = 8'd0;
    assign window_hann[23] = 8'd0;
    assign window_hann[24] = 8'd0;

    // hamm 窗 LUT
    assign window_hamm[ 0] = 8'd2;
    assign window_hamm[ 1] = 8'd11;
    assign window_hamm[ 2] = 8'd20;
    assign window_hamm[ 3] = 8'd11;
    assign window_hamm[ 4] = 8'd2;
    assign window_hamm[ 5] = 8'd11;
    assign window_hamm[ 6] = 8'd74;
    assign window_hamm[ 7] = 8'd138;
    assign window_hamm[ 8] = 8'd74;
    assign window_hamm[ 9] = 8'd11;
    assign window_hamm[10] = 8'd20;
    assign window_hamm[11] = 8'd138;
    assign window_hamm[12] = 8'd255;
    assign window_hamm[13] = 8'd138;
    assign window_hamm[14] = 8'd20;
    assign window_hamm[15] = 8'd11;
    assign window_hamm[16] = 8'd74;
    assign window_hamm[17] = 8'd138;
    assign window_hamm[18] = 8'd74;
    assign window_hamm[19] = 8'd11;
    assign window_hamm[20] = 8'd2;
    assign window_hamm[21] = 8'd11;
    assign window_hamm[22] = 8'd20;
    assign window_hamm[23] = 8'd11;
    assign window_hamm[24] = 8'd2;

    // blk 窗 LUT
    assign window_blk[ 0] = 8'd0;
    assign window_blk[ 1] = 8'd0;
    assign window_blk[ 2] = 8'd0;
    assign window_blk[ 3] = 8'd0;
    assign window_blk[ 4] = 8'd0;
    assign window_blk[ 5] = 8'd0;
    assign window_blk[ 6] = 8'd29;
    assign window_blk[ 7] = 8'd87;
    assign window_blk[ 8] = 8'd29;
    assign window_blk[ 9] = 8'd0;
    assign window_blk[10] = 8'd0;
    assign window_blk[11] = 8'd87;
    assign window_blk[12] = 8'd255;
    assign window_blk[13] = 8'd87;
    assign window_blk[14] = 8'd0;
    assign window_blk[15] = 8'd0;
    assign window_blk[16] = 8'd29;
    assign window_blk[17] = 8'd87;
    assign window_blk[18] = 8'd29;
    assign window_blk[19] = 8'd0;
    assign window_blk[20] = 8'd0;
    assign window_blk[21] = 8'd0;
    assign window_blk[22] = 8'd0;
    assign window_blk[23] = 8'd0;
